...
Canvas.prototype.axes = function() {
	...
	return [
		[this.translatePoint(this.graph.x.min, 0), this.translatePoint(this.graph.x.max, 0)], 
		[this.translatePoint(0, this.graph.y.min), this.translatePoint(0, this.graph.y.max)]
	];
}
